        ...
        return [
            ...
            },
            {
                ...
                'fields': [
                    ...
                    ('Address Line 2', self.address.address_line_2 or '—'),
                    ('City', self.address.city or 'N/A'),
                    ('Region', self.address.region or '—'),
                    ('Postcode', self.address.postcode or 'N/A'),
                    ('Country', str(self.address.country_code) if self.address.country_code else 'N/A'),
                ],
            },
            {
                'title': 'Coordinates',
                ...
                'sections': [
                    {
                        'title': 'Company',
                        'fields': [
                            ('Name', self.contact.company_name or '—'),
                            ('Email', self.contact.company_email or '—'),
                            ('Phone', self.contact.company_phone or '—'),
                        ],
                    },
                    {
                        'title': 'Primary Contact',
                        'fields': [
                            ('Name', self.contact.primary_contact_name or '—'),
                            ('Email', self.contact.primary_contact_email or '—'),
                            ('Phone', self.contact.primary_contact_phone or '—'),
                        ],
                    },
                    {
                        'title': 'Land Owner',
                        'fields': [
                            ('Name', self.contact.land_owner_name or '—'),
                            ('Email', self.contact.land_owner_email or '—'),
                            ('Phone', self.contact.land_owner_phone or '—'),
                        ],
                    },
                    {
                        'title': 'Secondary Contact',
                        'fields': [
                            ('Name', self.contact.secondary_contact_name or '—'),
                            ('Email', self.contact.secondary_contact_email or '—'),
                            ('Phone', self.contact.secondary_contact_phone or '—'),
                        ],
                    },
                ],
            },
